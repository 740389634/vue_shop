   ...
   <div>
     <div class="top">
       ...
       <div class="i_car">
         ...
         <div class="car_bg">
           <!--Begin 购物车未登录 Begin-->
           <div class="un_login">还未登录！<a  style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
           <!--End 购物车未登录 End-->
           <!--Begin 购物车已登录 Begin-->
           <ul class="cars">
             <li>
         ...
         <div class="two_bg">
           ...
           <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
             ...
             <tr v-for="val in data">
               ...
               <td align="center">{{val.attribute_name}}</td>
               <td align="center">{{val.number}}</td>
               <td align="center" style="color:#ff4e00;">￥{{val.number*val.price}}</td>
           ...
           <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
             <tr height="70">
               <td align="right"><a @click="addaction()"><img src="/static/images/btn_sure.gif" /></a></td>
             </tr>
           </table>
         </div>
       </div>
...
export default {
  ...
  mounted() {
    axios.post(this.url + '/api/order/order', {
      id: this.id,
      token: this.token
    })
      .then(response => {
    ...
    axios.post(this.url + '/api/order/ress', {
      token: this.token
    })
      .then(response => {
  ...
  methods : {
    addaction () {
      ...
      axios.post(this.url + '/api/order/addaction', {
        token: this.token,
        id:id,
        address:this.arr[0].detailedaddress
      })
        .then(response => {
