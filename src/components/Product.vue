      ...
      <div class="i_bg">
        ...
        <div class="content">
          ...
          <div id="tsShopContainer">
            <div id="tsImgS"><a href="/static/images/p_big.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img src="/static/images/p_big.jpg" width="390" height="390" /></a></div>
          ...
          <div class="pro_des">
            ...
            <div class="des_choice" v-for="(v,k) in msg.data">
            ...
            <div class="des_join">
              <div class="j_nums">
                <input type="text" value="1" name="" class="n_ipt" id="a1"/>
                <input type="button" value="" onclick="addUpdate(jq(this));" class="n_btn_1" />
                <input type="button" value="" onclick="jianUpdate(jq(this));" class="n_btn_2" />
              </div>
              <span class="fl"><a @click="shoppingcate()"><img src="/static/images/j_car.png" /></a></span>
            </div>
          </div>
...
export default {
  ...
  mounted:function () {
    this.filters.id=this.$route.query.aId
    axios.post(this.url+'/api/show/product',{
      id: this.filters.id,
    })
      .then(response=> {
